...
function modifyMenuIfUserLogged(usuarioLogado) {
  if (usuarioLogado) {
    ...
    const sidebarTabletItem = document.getElementById(
      "sidebar-tab-item-logged"
    );
    const sidebarMobileItem = document.getElementById(
      "sidebar-mob-item-logged"
    );
